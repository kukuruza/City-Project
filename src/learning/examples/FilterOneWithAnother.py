...
from learning.dbModify    import filterOneWithAnother
...
setupLogging ('log/learning/filterOneWithAnother.log', args.logging_level, 'a')

(conn, cursor) = dbInit(args.in_db_file, args.out_db_file)
(conn_ref, cursor_ref) = dbInit(args.ref_db_file, backup=False)
filterOneWithAnother (cursor, cursor_ref)
