...
h5_in_file1 = 'data/patches/try-hdf5/training-negatives.h5'
h5_in_file2 = 'data/patches/try-hdf5/572-578-e0.1.h5'
h5_out_file = 'data/patches/try-hdf5/training-40x30.h5'
