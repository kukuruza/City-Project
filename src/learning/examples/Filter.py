...
from learning.dbModify import filterCustom, expandBboxes, filterByBorder, thresholdScore, deleteEmptyImages
...
if args.delete_empty_images:
  deleteEmptyImages (cursor)
if args.filter_by_border:
  filterByBorder (cursor, argv)
