...
#    db_in_path  = op.join (CITY_DATA_PATH, 'datasets/labelme/Databases/src-frames.db')
    db_in_path = op.join (CITY_DATA_PATH, 'datasets/sparse/Databases/572-Oct28-10h/color-ds2.5-dp12.0.db')
    db_out_path = op.join (CITY_DATA_PATH, 'datasets/sparse/Databases/572-Oct28-10h/color-ds2.5-dp12.0-2.db')
