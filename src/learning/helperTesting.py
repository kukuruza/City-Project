...
class TestMicroDbBase (unittest.TestCase):
    ...
    def setUp (self):
        ...
        s = 'images(imagefile,width,height,src,ghostfile,maskfile,time)'
        v = ('img1',100,100,'test','ghost1','mask1','2015-08-21 01:01:01.000')
        c.execute('INSERT INTO %s VALUES (?,?,?,?,?,?,?)' % s, v)
        v = ('img2',100,100,'test','ghost2','mask2','2015-08-21 01:01:02.000')
        c.execute('INSERT INTO %s VALUES (?,?,?,?,?,?,?)' % s, v)
        v = ('img3',100,100,'test','ghost3','mask3','2015-08-21 01:01:03.000')
        c.execute('INSERT INTO %s VALUES (?,?,?,?,?,?,?)' % s, v)
