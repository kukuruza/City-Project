...
//	Caffe::set_phase(Caffe::TEST);
	...
	Net<float> net("examples/city/predict.prototxt",caffe::TEST);

	// Load pre-trained net (binary proto)
	// Assume you are already trained the cifar10 example.
	net.CopyTrainedLayersFrom("examples/city/city_quick_iter_4000.caffemodel");
	...
	LOG(INFO)<< "argmaxLayer->num()"<<argmaxLayer->num();
