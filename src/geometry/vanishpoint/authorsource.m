function [args] = authorsource(grayImg,colorImg, norient, outputPath_final, numOfValidFiles)
...
for i=1:norient
    ...
    complexResponse(:,:,i) = hypot(filteredImgsOdd(:,:,i), filteredImgsEven(:,:,i));
